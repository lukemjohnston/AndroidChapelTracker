...
public class main_RecViewAdpt extends RecyclerView.Adapter<main_RecViewAdpt.Det_ViewHolder>{
    ...
    public main_RecViewAdpt(Context con, ArrayList<String> tit, ArrayList<String> tim, ArrayList<String> loc, ArrayList<String> dat) {
        context = con;
        titles = tit;
        times = tim;
        dates = dat;
    ...
    public Det_ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View c_view = c_inflater.inflate(R.layout.layout_main, parent, false);
